...
import com.example.fincas_grupo3.infrastructure.mappers.direccion.DireccionMapper; // <-- IMPORTANTE: Añadir este import
import org.mapstruct.Mapper;
import org.mapstruct.Mapping;


@Mapper(componentModel = "spring", implementationName = "usuarioMapperInfra", uses = {RolMapper.class, DireccionMapper.class})
