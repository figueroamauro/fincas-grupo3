...
@Mapper(componentModel = "spring",
        uses = {DireccionMapper.class, UsuarioMapper.class, ServicioMapper.class, HorarioDisponibleMapper.class, FotoMapper.class},
        implementationName = "fincaMapperInfra")
public abstract class FincaMapper {

    @Mapping(source = "horarioDisponibleEntidadList", target = "horarioDisponibleList")
    ...
    @Mapping(source = "horarioDisponibleList", target = "horarioDisponibleEntidadList")
    @Mapping(source = "tipoReservas", target = "tipoReservas")
    @Mapping(source = "fotos", target = "fotos")
